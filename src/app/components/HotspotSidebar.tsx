import { ArrowLeft, Users, TrendingUp, MessageCircle, Briefcase } from 'lucide-react';
...
export function HotspotSidebar({ onBack, clientTrust, fitConfidence, engagement }: HotspotSidebarProps) {
  return (
    <div className="w-80 bg-white border-r border-gray-200 min-h-screen flex flex-col">
      ...
      <div className="flex-1 p-6 space-y-6">
        ...
        {/* Illustration */}
        <motion.div 
          className="bg-gradient-to-br from-purple-100 to-blue-100 rounded-xl p-8 flex items-center justify-center"
        ...
        >
          <div className="text-center space-y-2">
            ...
            <p className="text-sm text-gray-600 font-medium">Interactive Challenge</p>
          </div>
        </motion.div>
