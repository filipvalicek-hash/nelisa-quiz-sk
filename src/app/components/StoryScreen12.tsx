...
export function StoryScreen12({ onContinue, onBack, onLogoClick }: StoryScreen12Props) {
  const storyContent = (
    <>
      ...
      <p className="mb-4">
        „A kdo nám s tím pomůže <span style={{ background: 'linear-gradient(180deg, transparent 60%, rgba(174, 84, 255, 0.18) 60%)', padding: '0 2px' }}>na začátku</span>?" ptá se. „Nechci, aby se to ztratilo mezi e-maily."
      </p>
      <p>
